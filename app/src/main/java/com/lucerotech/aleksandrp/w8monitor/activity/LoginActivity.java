...
import com.lucerotech.aleksandrp.w8monitor.activity.interfaces.presentts.LoginPresenter;
import com.lucerotech.aleksandrp.w8monitor.activity.interfaces.views.LoginView;
import com.lucerotech.aleksandrp.w8monitor.presents.login.presenter.LoginPresenterImpl;
...
//    =================================================
    ...
    public void userExist(boolean mUserExist, UserLibr mUser) {
        if (mUserExist) {
            ...
            SettingsApp.getInstance().setAutoLogin(mUser.getKeep_login() > 0);
