...
import com.lucertech.w8monitor.android.adapter.CirclePagerAdapterMain;
import com.lucertech.w8monitor.android.d_base.model.ParamsBody;
import com.lucertech.w8monitor.android.fragments.main.view.ViewPagerCustomDuration;
...
import static com.lucertech.w8monitor.android.R.color.color_light_text;
import static com.lucertech.w8monitor.android.R.color.color_light_text_light;
import static com.lucertech.w8monitor.android.R.color.color_light_text_transparent_light;
import static com.lucertech.w8monitor.android.R.color.pageColor_light;
import static com.lucertech.w8monitor.android.R.id.rl_view;
import static com.lucertech.w8monitor.android.R.id.view;
import static com.lucertech.w8monitor.android.utils.FontsTextView.getFontRoboLight;
import static com.lucertech.w8monitor.android.utils.FontsTextView.getFontRobotoLight;
import static com.lucertech.w8monitor.android.utils.GetSizeWindow.getSizeWindow;
...
import static com.lucertech.w8monitor.android.utils.STATICS_PARAMS.PICKER_BMI;
import static com.lucertech.w8monitor.android.utils.STATICS_PARAMS.PICKER_BONE_MASS;
import static com.lucertech.w8monitor.android.utils.STATICS_PARAMS.PICKER_CALORIES;
import static com.lucertech.w8monitor.android.utils.STATICS_PARAMS.PICKER_DAY;
import static com.lucertech.w8monitor.android.utils.STATICS_PARAMS.PICKER_DAY_;
import static com.lucertech.w8monitor.android.utils.STATICS_PARAMS.PICKER_FAT;
import static com.lucertech.w8monitor.android.utils.STATICS_PARAMS.PICKER_FAT_LEVEL;
import static com.lucertech.w8monitor.android.utils.STATICS_PARAMS.PICKER_MONTH;
import static com.lucertech.w8monitor.android.utils.STATICS_PARAMS.PICKER_MONTH_;
import static com.lucertech.w8monitor.android.utils.STATICS_PARAMS.PICKER_MUSCLE_MASS;
import static com.lucertech.w8monitor.android.utils.STATICS_PARAMS.PICKER_WATER;
import static com.lucertech.w8monitor.android.utils.STATICS_PARAMS.PICKER_WEEK;
import static com.lucertech.w8monitor.android.utils.STATICS_PARAMS.PICKER_WEEK_;
import static com.lucertech.w8monitor.android.utils.STATICS_PARAMS.PICKER_WEIGHT;
import static com.lucertech.w8monitor.android.utils.STATICS_PARAMS.PICKER_YEAR;
import static com.lucertech.w8monitor.android.utils.STATICS_PARAMS.PICKER_YEAR_;
import static com.lucertech.w8monitor.android.utils.STATICS_PARAMS.TIME_IN_DAY;
import static com.lucertech.w8monitor.android.utils.STATICS_PARAMS.TIME_IN_MONTH;
import static com.lucertech.w8monitor.android.utils.STATICS_PARAMS.TIME_IN_WEEK;
import static com.lucertech.w8monitor.android.utils.STATICS_PARAMS.TIME_IN_YEAR;
import static com.lucertech.w8monitor.android.utils.TranslateToMetric.translateToMetricFloat;
...
//        mChart.fitScreen();
        ...
        // to use for it
        com.lucertech.w8monitor.android.fragments.main.view.MyMarkerView mv = new com.lucertech.w8monitor.android.fragments.main.view.MyMarkerView(getActivity(), R.layout.custom_marker_view);
...
//        y.setAxisMinValue(-10);
    ...
    private void setColorFromTheme(XAxis mX, YAxis mY) {
        if (SettingsApp.getInstance().isThemeDark()) {
            mX.setTextColor(getActivity().getResources().getColor(color_light_text));
            mX.setAxisLineColor(getActivity().getResources().getColor(R.color.color_select_tab));
            mY.setTextColor(getActivity().getResources().getColor(color_light_text));
            mY.setGridColor(getActivity().getResources().getColor(R.color.color_default_tab));
        } else {
            mX.setTextColor(getActivity().getResources().getColor(color_light_text_light));
            mX.setAxisLineColor(getActivity().getResources().getColor(R.color.color_select_tab_light));
            mY.setTextColor(getActivity().getResources().getColor(color_light_text_light));
