...
implements Runnable {
    ...
    public BathScaleActivity() {
            ...
            public void onClick(View view) {
                switch (view.getId()) {
                    ...
                    case 2131296300: {
                        ...
                        intent.setClass((Context)BathScaleActivity.this, (Class)InfoActivity.class);
                    ...
                    case 2131296301: {
                        Intent intent = new Intent();
                        intent.setFlags(268435456);
                        intent.setClass((Context)BathScaleActivity.this, (Class)SettingActivity.class);
                        BathScaleActivity.this.startActivity(intent);
                        return;
                    }
                    case 2131296302: 
                }
                BathScaleActivity.this.dialog(BathScaleActivity.this.getString(2131361847), view.getId());
            }
        };
        this.btnOnClickListener = new View.OnClickListener(){
            ...
            public void onClick(View view) {
                ...
                intent.setClass((Context)BathScaleActivity.this, (Class)UserListActivity.class);
                BathScaleActivity.this.startActivity(intent);
            }
        };
        this.imgOnClickListener = new View.OnClickListener(){
            ...
            public void onClick(View view) {
                Intent intent = new Intent();
                intent.setClass((Context)BathScaleActivity.this, (Class)RecordListActivity.class);
            ...
            public void handleMessage(Message message) {
                ...
                switch (message.what) {
                    case 0: {
                        ...
                        if (TextUtils.isEmpty((CharSequence)UtilConstants.FIRST_INSTALL_BATH_SCALE) && CacheHelper.recordListDesc.size() > 0) {
                    ...
                    case 5: {
                        ...
                        ExitApplication.getInstance().exit((Context)BathScaleActivity.this);
                        return;
                    }
                    case 101: 
                }
                ...
                ExitApplication.getInstance().exit((Context)BathScaleActivity.this);
                Intent intent = new Intent();
                intent.setClass((Context)BathScaleActivity.this, (Class)LoadingActivity.class);
                BathScaleActivity.this.startActivity(intent);
            }
        };
        ...
        this.mServiceConnection = new ServiceConnection(){
            ...
            public void onServiceConnected(ComponentName componentName, IBinder iBinder) {
                BathScaleActivity.access$5(BathScaleActivity.this, ((BluetoothLeService.LocalBinder)iBinder).getService());
                ...
                BathScaleActivity.access$7(BathScaleActivity.this, true);
            }

            public void onServiceDisconnected(ComponentName componentName) {
                BathScaleActivity.access$5(BathScaleActivity.this, null);
                BathScaleActivity.access$7(BathScaleActivity.this, false);
            }
        };
        this.mGattUpdateReceiver = new BroadcastReceiver(){
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                if ("com.example.bluetooth.le.ACTION_GATT_CONNECTED".equals((Object)string2)) {
                    ...
                    BathScaleActivity.this.scale_connect_state.setText(2131361919);
                    if (!BathScaleActivity.this.singleton.getmConnected()) return;
                    {
                        BathScaleActivity.this.singleton.setmConnected(false);
                        if (BathScaleActivity.this.mBluetoothLeService != null) {
                            boolean bl = BathScaleActivity.this.mBluetoothLeService.connect(BluetoolUtil.mDeviceAddress);
                    ...
                    BathScaleActivity.access$10(BathScaleActivity.this, 0);
                    BathScaleActivity.this.scale_connect_state.setText(2131361918);
                    AppData.hasCheckData = true;
                    Toast.makeText((Context)BathScaleActivity.this, (CharSequence)BathScaleActivity.this.getString(2131361912), (int)1).show();
                    Toast.makeText((Context)BathScaleActivity.this, (CharSequence)BathScaleActivity.this.getString(2131361912), (int)1).show();
                    if (BathScaleActivity.this.mBluetoothLeService == null) return;
                    {
                        new Thread(new Runnable(){

                            public void run() {
                                if (6.this.BathScaleActivity.this.singleton.getmConnected() && 6.this.BathScaleActivity.this.mBluetoothLeService != null) {
                                    6.this.BathScaleActivity.this.send_Data();
                                }
                            }
                        }).start();
                        return;
                    ...
                    if (!"com.example.bluetooth.le.ACTION_DATA_AVAILABLE".equals((Object)string2)) return;
                    {
                        ...
                        if (string3.equals((Object)UtilConstants.ERROR_CODE)) {
                            if (BathScaleActivity.this.sendCodeCount <= 2) {
                                ...
                                BathScaleActivity bathScaleActivity = BathScaleActivity.this;
                                BathScaleActivity.access$10(bathScaleActivity, 1 + bathScaleActivity.sendCodeCount);
                            } else {
                                Toast.makeText((Context)BathScaleActivity.this, (CharSequence)BathScaleActivity.this.getString(2131361911), (int)0).show();
                            }
                        } else if (string3.equals((Object)UtilConstants.ERROR_CODE_TEST)) {
                            Toast.makeText((Context)BathScaleActivity.this, (CharSequence)BathScaleActivity.this.getString(2131361914), (int)0).show();
                        }
                        if (System.currentTimeMillis() - UtilConstants.receiveDataTime < 1000) return;
                        {
                            ...
                            if (!string3.startsWith(UtilConstants.BATHROOM_SCALE) && string3.length() > 31) {
                                if (string3.startsWith(UtilConstants.BODY_SCALE)) {
                                    ...
                                    RecordDao.dueDate(BathScaleActivity.this.recordService, string3);
                                    ...
                                    UtilConstants.CURRENT_USER.setScaleType(UtilConstants.CURRENT_SCALE);
                                    RecordDao.dueKitchenDate(BathScaleActivity.this.recordService, string3, null);
                                }
                            ...
                            {
                                BathScaleActivity.this.dueDate(string3);
                                return;
                            }
                        }
                    }
                ...
                if ("android.bluetooth.device.action.FOUND".equals((Object)string2)) {
                    ...
                    if (bluetoothDevice == null) return;
                    {
                        ...
                        if (string3 == null || !string3.equalsIgnoreCase("Electronic Scale")) return;
                        {
                            ...
                            BathScaleActivity.this.handler.postDelayed(BathScaleActivity.this.ScanRunnable, 15000);
                            return;
                        }
                    }
                } else {
                    ...
                    {
                        BathScaleActivity.this.stopDiscovery();
                        BathScaleActivity.this.handler.postDelayed(BathScaleActivity.this.ScanRunnable, 10000);
                        return;
                    }
                }
            }
    ...
    static /* synthetic */ void access$10(BathScaleActivity bathScaleActivity, int n) {
        bathScaleActivity.sendCodeCount = n;
    }

    static /* synthetic */ void access$19(BathScaleActivity bathScaleActivity, int n) {
        bathScaleActivity.selectedPosition = n;
    }

    static /* synthetic */ void access$21(BathScaleActivity bathScaleActivity, Records records) {
        bathScaleActivity.curRecord = records;
    }

    static /* synthetic */ Records access$25(BathScaleActivity bathScaleActivity) {
        return bathScaleActivity.curRecord;
    }

    static /* synthetic */ int access$26(BathScaleActivity bathScaleActivity) {
        return bathScaleActivity.ItemID;
    }

    static /* synthetic */ void access$5(BathScaleActivity bathScaleActivity, BluetoothLeService bluetoothLeService) {
        bathScaleActivity.mBluetoothLeService = bluetoothLeService;
    }

    static /* synthetic */ void access$7(BathScaleActivity bathScaleActivity, boolean bl) {
        bathScaleActivity.isServiceReg = bl;
    }
        ...
        this.pager.setOnPageChangeListener(new ViewPager.OnPageChangeListener(){
            ...
            public void onPageSelected(int n) {
                if (BathScaleActivity.this.views != null && BathScaleActivity.this.views.size() > 0) {
                    if (n == -1 + BathScaleActivity.this.views.size() || n == 0) {
                        if (n == 0) {
                            BathScaleActivity.this.pager.setCurrentItem(n + 1);
                        } else {
                            BathScaleActivity.this.pager.setCurrentItem(n - 1);
                        }
                    } else {
                        if (n > 0) {
                            BathScaleActivity.access$19(BathScaleActivity.this, n - 1);
                        } else {
                            BathScaleActivity.access$19(BathScaleActivity.this, 0);
                        }
                        BathScaleActivity.access$21(BathScaleActivity.this, (Records)CacheHelper.recordListDesc.get(BathScaleActivity.this.selectedPosition));
                        BathScaleActivity.this.handler.sendEmptyMessage(1);
                    }
                    if (BathScaleActivity.this.pager.getCurrentItem() < 2) {
                        BathScaleActivity.this.leftImg.setImageDrawable(BathScaleActivity.this.getResources().getDrawable(2130837610));
                    } else {
                    ...
                    if (BathScaleActivity.this.pager.getCurrentItem() >= -2 + BathScaleActivity.this.views.size()) {
                        BathScaleActivity.this.rightImg.setImageDrawable(BathScaleActivity.this.getResources().getDrawable(2130837649));
                        return;
                    }
    ...
    private void showTipMask() {
        HighLightGuideView.builder(this).setText(this.getString(2131361792)).addNoHighLightGuidView(2130837592).addHighLightGuidView((View)this.pager, 0, 0.5f, 1).setTouchOutsideDismiss(false).setOnDismissListener(new HighLightGuideView.OnDismissListener(){
            ...
            public void onDismiss() {
                if (UtilConstants.su == null) {
                    UtilConstants.su = new SharedPreferencesUtil((Context)BathScaleActivity.this);
                }
    ...
    protected void dialog(String string2, final int n) {
        ...
        builder.setPositiveButton(2131361854, new DialogInterface.OnClickListener(){
            ...
            public void onClick(DialogInterface var1_1, int var2_2) {
                ...
                try {
                    if (BathScaleActivity.access$25(BathScaleActivity.this) != null) {
                        BathScaleActivity.access$13(BathScaleActivity.this).delete(BathScaleActivity.access$25(BathScaleActivity.this));
                    }
                    if ((CacheHelper.recordListDesc = BathScaleActivity.access$13(BathScaleActivity.this).getAllDatasByScaleAndIDDesc(UtilConstants.CURRENT_USER.getScaleType(), BathScaleActivity.access$26(BathScaleActivity.this), 167.0f)) == null || CacheHelper.recordListDesc.size() <= 0) ** GOTO lbl17
                    BathScaleActivity.access$21(BathScaleActivity.this, (Records)CacheHelper.recordListDesc.get(0));
lbl14: // 2 sources:
                    do {
...
lbl17: // 1 sources:
                    BathScaleActivity.access$21(BathScaleActivity.this, null);
                    ** continue;
                }
    ...
    public void dueDate(String string2) {
        BathScaleActivity bathScaleActivity = this;
        synchronized (bathScaleActivity) {
